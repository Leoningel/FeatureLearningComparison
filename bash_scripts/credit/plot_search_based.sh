...
run_comparison.sh -fl 0 1 2 -m 0 --plot_data -fn credit/max_depth_12 --time -v -out search_methods -p 2 -o
run_comparison.sh -fl 0 1 2 -m 0 --plot_data -fn credit/max_depth_12 --nodes -g -out search_methods -p -1 -o
