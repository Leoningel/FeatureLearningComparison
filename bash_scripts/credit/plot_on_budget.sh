...
run_comparison.sh -fl 0 2 5 6 7 8 -m 0 --plot_data -fn credit/time -t -v -out timed_compare_w_classics -p 0
run_comparison.sh -fl 0 2 5 6 7 8 -m 0 --plot_data -fn credit/time -v -out timed_compare_w_classics -p 0
run_comparison.sh -fl 0 2 5 6 7 8 -m 1 --plot_data -fn credit/time -t -v -out timed_compare_w_classics -p 0
run_comparison.sh -fl 0 2 5 6 7 8 -m 1 --plot_data -fn credit/time -v -out timed_compare_w_classics -p 0
run_comparison.sh -fl 0 2 5 6 7 8 -m 2 --plot_data -fn credit/time -t -v -out timed_compare_w_classics -p 0 -o
run_comparison.sh -fl 0 2 5 6 7 8 -m 2 --plot_data -fn credit/time -v -out timed_compare_w_classics -p 0 -o
run_comparison.sh -fl 0 2 5 6 7 8 -m 3 --plot_data -fn credit/time -t -v -out timed_compare_w_classics -p 0
run_comparison.sh -fl 0 2 5 6 7 8 -m 3 --plot_data -fn credit/time -v -out timed_compare_w_classics -p 0
