...
# run_comparison.sh -fl 2 4 -m 0 --plot_data -fn credit/max_depth_7 -t -g -out jb_gengy_depth_7 -p -1 -o
# run_comparison.sh -fl 2 4 -m 0 --plot_data -fn credit/max_depth_7 -g -out jb_gengy_depth_7 -p -1 -o
