...
run_comparison.sh -fl 0 1 2 3 -m 1 --plot_data -fn bb/max_depth_12 -t -v -out search_methods_full
run_comparison.sh -fl 0 1 2 3 -m 1 --plot_data -fn bb/max_depth_12 -v -out search_methods_full
